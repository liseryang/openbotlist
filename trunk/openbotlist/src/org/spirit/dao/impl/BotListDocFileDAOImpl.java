...
public class BotListDocFileDAOImpl extends HibernateDaoSupport implements BotListDocFileDAO {
		...
		return getHibernateTemplate().executeFind(
				new HibernateCallback() {
					public Object doInHibernate(Session session) throws HibernateException {
						String querystr = "from org.spirit.bean.impl.BotListDocFile file order by file.createdOn";
	...
	public List listFilesHistory() {
		return getHibernateTemplate().executeFind(
				new HibernateCallback() {
					public Object doInHibernate(Session session) throws HibernateException {
						String querystr = "from org.spirit.bean.impl.BotListDocFile file order by file.createdOn desc";
						Query query = session.createQuery(querystr);
